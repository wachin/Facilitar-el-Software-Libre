¡Esa es una excelente pregunta\! Saber lo que significa esa opción es clave para lograr tu objetivo de reducir el tamaño del repositorio.

La opción **"Copy the master branch only"** (o "Copiar solo la rama principal") significa lo siguiente:
